        ...
        <ul className="sidebar-links" id="simple-bar">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-home" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-home" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-widget" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-widget" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-layout" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-layout" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack">  </i><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-project" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-project" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="file-manager.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-file" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-file" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack">      </i><a className="sidebar-link sidebar-title link-nav" href="kanban.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-board" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-board" />
              </svg><span>kanban Board</span></a></li>
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-ecommerce" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-ecommerce" />
            ...
            <ul className="sidebar-submenu">
              ...
              <li><a className="submenu-title" href="#">Invoices
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-email" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-email" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-chat" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-chat" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-user" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-user" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="bookmark.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-bookmark" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="contacts.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-contact" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="task.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-task" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-calendar" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-calender" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="social-app.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-social" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="to-do.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-to-do" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="search.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-search" />
              </svg>
              <svg className="fill-icon">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-form" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-form"> </use>
              </svg><span>Forms</span></a>
            <ul className="sidebar-submenu">
              <li><a className="submenu-title" href="#">Form Controls
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
                <ul className="submenu-content opensubmegamenu">
              ...
              <li><a className="submenu-title" href="#">Form Widgets
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
                <ul className="submenu-content opensubmegamenu">
              ...
              <li><a className="submenu-title" href="#">Form layout
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
                <ul className="submenu-content opensubmegamenu">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-table" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-table" />
              </svg><span>Tables</span></a>
            <ul className="sidebar-submenu">
              <li><a className="submenu-title" href="#">Bootstrap Tables
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
                <ul className="submenu-content opensubmegamenu">
              ...
              <li><a className="submenu-title" href="#">Data Tables
                  <h5 className="sub-arrow"><i className="fa fa-angle-right" /></h5></a>
                <ul className="submenu-content opensubmegamenu">
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-ui-kits" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-ui-kits" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-bonus-kit" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-bonus-kit" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              ...
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-animation" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-icons" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-icons" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-button" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-button" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-charts" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-charts" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="landing-page.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-landing-page" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-landing-page" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="sample-page.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-sample-page" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-sample-page" />
              </svg><span>Sample page</span></a></li>
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="translate.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-internationalization" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-internationalization" />
              </svg><span>Translate</span></a></li>
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="https://admin.pixelstrap.net/dunzo/starter-kit/index.html" target="_blank">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-starter-kit" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-starter-kit" />
          ...
          <li className="mega-menu sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-others" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-others" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-gallery" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-gallery" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-blog" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-blog" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="faq.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-faq" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-faq" />
              </svg><span>FAQ</span></a></li>
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-job-search" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-job-search" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-learning" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-learning" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-maps" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-maps" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title" href="#">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-editors" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-editors" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="knowledgebase.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-knowledgebase" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-knowledgebase" />
          ...
          <li className="sidebar-list"><i className="fa fa-thumb-tack" /><a className="sidebar-link sidebar-title link-nav" href="support-ticket.html">
              <svg className="stroke-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#stroke-support-tickets" />
              </svg>
              <svg className="fill-icon">
                <use href="https://admin.pixelstrap.net/dunzo/assets/svg/icon-sprite.svg#fill-support-tickets" />
